...
public class SidebarHeader extends Composite {
	...
	interface SidebarHeaderUiBinder extends UiBinder<Widget, SidebarHeader> {
	}

	public SidebarHeader(SidebarHandler handler) {
